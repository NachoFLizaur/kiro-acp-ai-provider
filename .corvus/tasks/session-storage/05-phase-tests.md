...
```bash
# Run all tests
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && bun test

# Run only session storage tests
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && bun test test/session-storage.test.ts

# Run only model tests (includes new affinity tests)
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && bun test test/kiro-acp-model.test.ts

# Type check
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && npx tsc --noEmit

# Build
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && npm run build
```
