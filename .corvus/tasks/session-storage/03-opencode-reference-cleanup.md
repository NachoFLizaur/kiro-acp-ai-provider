...
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && ! rg -i "opencode" --type ts src/

# Run existing tests (some may fail — test fixtures updated in task 04)
cd /Users/user/Documents/5-coding/open-source/kiro-acp-ai-provider && bun test || true
```
